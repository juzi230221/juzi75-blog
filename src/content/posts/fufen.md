...
例如：化学年段最高分 $91$ ，A线最低分 $60$ 。一个同学考了 $73$ ，代入公式：
...
> 年段由于一些原因，会调整赋分比例，只能问得A线约 $50\%$ ，因此试图逆推年段比率
...
那么：
- 已知 $F$ -> 所在等级
- 已知 $O$ + $F$ + $F_{upper}$ + $F_{lower}$  ->  $O_{upper}$ + $O_{lower}$ 
...
例如：化学年段最高分 $91$ ，一个同学考了 $73$ ，赋出来 $92>85$ ，显然A。代入公式：
...
可见，计算存在误差，特别是该科人数少的时候。但是 $50\%$ 是个极好的数字，大概率是正确的。与获得的A线信息比照也说明算法正确。
