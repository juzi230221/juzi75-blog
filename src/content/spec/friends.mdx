...
export const site = {
  name: "橘子75",
  desc: "The world of 🍊",
  url: "https://juzi75.uuk.moe",
  avatar: "404 Not Found",
  email: "juzi75@qq.com",
};
...
export const notes = [
  { title: "互换原则", content: "请将本站添加到您的友链页面，后会添加您的友链" },
  { title: "链接维护", content: "友链网站长期无法访问，将会被移除" },
  { title: "内容要求", content: "不含有任何违法违规内容" },
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">发送邮件至：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code></p>
