	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"————小橘小橘<br>————哎，我在",
				"心若没有栖息的地方，到哪里都是在流浪",
				"年少莫问归途，岁月自有回响<br>步履不负韶华，人生自有远方",
				"岁月极美，在于它必然的流逝",
				"青春不是年华，而是心境",
				"成为你自己",
				...
				"千般荒凉 以此为梦<br>万里蹀躞 以此为归",
				"云天收夏色，木叶动秋声",
				"不随便评价他人，是一种修养<br>不活在别人的评价里，是一种修行",
				"当我说“未来”的时候，我刚一念它就成了过去",
				"人不是被定义的结果，而是拒绝被定义的奇迹",
				"敬我不能，尽我所能",
				"沉默是言语的秩序",
				"心存善意，才会被世界温柔以待",
				"人生如逆旅，我亦是行人",
				...
				"生命是一棵长满可能的树",
				"岁月失语，惟石能言",
				"行走不是为了到达，而是为了在移动中保持静止，好让世界向你走来",
				"生如夏花之绚烂，死如秋叶之静美",
				"欲买桂花同载酒，终不似，少年游",
				"将自己的悲剧当笑话讲给你听，直到你说这并不好笑",
				"水是喧哗的，深水是沉默的",
				"为者败之，执者失之",
				"不要把自己框在一时一刻的局促里",
				"没有人是一座孤岛",
